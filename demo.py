...
class Books():
    def __init__(self, title, author, genre, total_cp, available_cp, isbn_no, publish_year, shelf):
        ...
        if title in data:
            ...
            self.genre = data[name]["genre"]
            self.total_cp = data[name]["total copies"]
            self.available_cp = data[name]["available copies"]
            self.isbn_no = data[name]["isbn no"]
            self.publish_year = data[name]["publish year"]
            self.shelf = data[name]["shelf"]
        else:
            print("New Book")
            self.save()
